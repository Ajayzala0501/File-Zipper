	...
	private static void createAndShowGUI() {
		...
		helpItem.addActionListener(
				...
				new ActionListener() {
					...
					public void actionPerformed(ActionEvent event) {
						JOptionPane.showMessageDialog(null,
								"The Huffmans Codes algorithms are used for file compression" + "\n"
		...
		aboutItem.addActionListener(
				...
				new ActionListener() {
					public void actionPerformed(ActionEvent event) {
						JOptionPane.showMessageDialog(null,
								"File Zipper is a software to zip and unzip files" + "\n"
										+ "It is developed on JAVA, as a personal project of" + "\n"
										+ " Level - 2, Term - 1,Dept. of CSE,BUET." + "\n"
										+ "It is completed by Ajay Zala Kamal (St. ID 0805006) under" + "\n",
